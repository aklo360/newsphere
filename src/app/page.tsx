  ...
  return (
    <>
      ...
      <main className="min-h-screen flex flex-col items-center justify-center p-6">
        ...
        {/* Glass Cards */}
        <div className="flex flex-col md:flex-row gap-4 max-w-xl w-full">
          {/* Card 1: Create */}
          <Link href="/create" className="flex-1 group">
            ...
            ">
              ...
              <div className="relative">
                {/* Icon */}
                <div className="w-7 h-7 mb-4 rounded-lg bg-white/40 backdrop-blur-sm border border-white/40 flex items-center justify-center shadow-[inset_0_1px_1px_rgba(255,255,255,0.5)]">
                ...
                <h2 className="text-xs font-medium text-neutral-600 mb-1 tracking-wide">
                  I need a brand
                </h2>
                ...
                <ul className="space-y-1.5 mb-4 text-[9px] text-neutral-400">
                  <li className="flex items-center gap-2">
                    <span className="w-0.5 h-0.5 rounded-full bg-neutral-300" />
                    Generate name & identity
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-0.5 h-0.5 rounded-full bg-neutral-300" />
                ...
                <div className="
                  ...
                  text-[9px] font-medium text-white/90 tracking-wide
            ...
            ">
              ...
              <div className="relative">
                ...
                <div className="
                  ...
                  text-[9px] font-medium text-neutral-500 tracking-wide
                  flex items-center justify-center
        ...
        {/* Footer */}
        <p className="mt-16 text-[9px] tracking-[0.15em] text-neutral-400/60 uppercase">
