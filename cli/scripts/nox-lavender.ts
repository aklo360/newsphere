/**
 * Generate Nox owl with SOLID LAVENDER BACKGROUND + BEAK ONLY
 */
...
const OUTPUT_DIR = "./output/nox/mascot/lavender";
...
BACKGROUND: Solid flat #C8B4DC lavender/light purple color
- NOT transparent
- NOT checkered
- NOT white
- SOLID FLAT LAVENDER (#C8B4DC) background

BIRD ANATOMY:
- Small triangular BEAK only (no mouth line)
